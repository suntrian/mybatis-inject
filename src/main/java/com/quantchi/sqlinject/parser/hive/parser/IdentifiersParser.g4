...
expression
    : atomExpression ((LSQUARE expression RSQUARE) | (DOT identifier))*             #precedenceFieldExpression
    | precedenceUnaryOperator expression                                            #precedenceUnaryPrefixExpression
    | expression KW_IS isCondition                                                  #precedenceUnarySuffixExpression
    | expression precedenceBitwiseXorOperator expression                            #precedenceBitwiseXorExpression
    | expression precedenceStarOperator expression                                  #precedenceStarExpression
    | expression precedencePlusOperator expression                                  #precedencePlusExpression
    | expression precedenceConcatenateOperator expression                           #precedenceConcatenateExpression
    | expression precedenceAmpersandOperator expression                             #precedenceAmpersandExpression
    | expression precedenceBitwiseOrOperator expression                             #precedenceBitwiseOrExpression
    | expression precedenceSimilarExpressionPart                                    #precedenceSimilarExpression
    | KW_EXISTS subQueryExpression                                                  #precedenceExistsExpression
    | expression (precedenceEqualOperator | precedenceDistinctOperator) expression  #precedenceEqualExpression
    | precedenceNotOperator expression                                              #precedenceNotExpression
    | expression precedenceAndOperator expression                                   #precedenceAndExpression
    | expression precedenceOrOperator expression                                    #precedenceOrExpression
    | LPAREN expression RPAREN                                                      #precedenceParenExpression
    ;
...
dropPartitionVal
    : identifier dropPartitionOperator defaultVal
    ;
...
nonReserved
    ...
    | KW_EXCHANGE | KW_DESCRIBE | KW_USER | KW_DATE
